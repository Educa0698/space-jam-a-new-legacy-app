// Constantes para índices de columnas en los datos de los jugadores
const nameIndex = 1; // Indice para la columna de nombre del jugador
const perIndex = 2;  // Indice para la columna de PER
